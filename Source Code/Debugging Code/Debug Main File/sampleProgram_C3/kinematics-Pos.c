...
void InverseKin1pos (double F[4][4], double theta[7])
{
    double t1 ;
    double t2 ;
    double t3 = 0;
...
void InverseKin2pos(double F[4][4], double Ainv[3][4][4], double theta[7])
{
    double t5;
    double t6;
    double t7;
...
void InverseKin1neg(double F[4][4], double theta[7])
{
	double t1;
	double t2;
	double t3 = 0;
...
void InverseKin2neg(double F[4][4], double Ainv[3][4][4], double theta[7])
{
	double t5;
	double t6;
	double t7;
...
void InverseKin1pn(double F[4][4], double theta[7])
{
	double t1;
	double t2;
	double t3 = 0;
...
void InverseKin2pn(double F[4][4], double Ainv[3][4][4], double theta[7])
{
	double t5;
	double t6;
	double t7;
...
void IKpos (double theta[7], double T[4][4])
{
    ...
    InverseKin1pos(T,theta); /*calculate the first three angke*/
...
void IKneg(double theta[7], double T[4][4])
{
	...
	InverseKin1neg(T, theta); /*calculate the first three angke*/
	...
	InverseKin2neg(T, Ainv, theta);
}

void IKpn(double theta[7], double T[4][4])
{
	double C[4][4][4]; /*Matrix to store T.matrix obtained from Inverse kinematics*/
	double Ainv[4][4][4]; /*set of inverse of transformation matrix*/
	double DH[7][4];
	...
	InverseKin1pn(T, theta); /*calculate the first three angke*/
...
/*int main()
{
    ...
    FK(theta,T);
    Print(T);
	if (theta[1] < 0 && theta[3] < 0 && theta[5] < 0) IKneg(thetaInv, T);
	else if(theta[1] > 0 && theta[3] > 0 && theta[5] > 0) IKpos(thetaInv, T);
	else IKpn(thetaInv, T);
