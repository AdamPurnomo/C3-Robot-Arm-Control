...
linepathGenerate(struct status *Des_j, unsigned long Time)
{
    ...
    if(Time%1000==0)
    {
        printf("%lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf\n", dumt+realt, cur_j[0].pos, cur_j[1].pos, cur_j[2].pos, cur_j[3].pos, cur_j[4].pos, cur_j[5].pos, cur_j[6].pos, lpath.T[0][3], lpath.T[1][3], lpath.T[2][3]);
        /*Printmatrix(lpath.T);:*/
    }
}
void
...
{
    double destime = 10;
    double theta[7] = {10, 20, 0, 30, 40, 50, 60};
