...
circlepathGenerate(struct status *Des_j, unsigned long Time)
{
    ...
    if(Time%100==0)
    {
        printf("%lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf, %lf\n", dumt+realt, RAD2DEG*cur_j[0].pos, RAD2DEG*cur_j[1].pos, RAD2DEG*cur_j[2].pos, RAD2DEG*cur_j[3].pos, RAD2DEG*cur_j[4].pos, RAD2DEG*cur_j[5].pos, RAD2DEG*cur_j[6].pos, cpath.T[0][3], cpath.T[1][3], cpath.T[2][3], RAD2DEG*cpath.phase);
        /*Printmatrix(lpath.T);:*/
    }
}
